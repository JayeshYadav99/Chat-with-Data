...
export default async function Page() {
  ...
  if (userId) {
    const { success, data } = (await getFirstChatByUserId({ userId })) as {
      success: boolean;
      data: null | any[];
    };
    if (success) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-700">
                Seamlessly upload and organize your documents in various
                formats.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-700">
                Ask questions and get real-time answers from your documents.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-700">
                Easily find and summarize key information from your documents.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-700">
                Export your chat conversations in various formats for easy
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-700">
                Share your chat sessions with colleagues or friends for
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-700">
                Create new chat branches from existing conversations for
